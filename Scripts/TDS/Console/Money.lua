...
ScreenGui.Name = "Console_" .. _E.RS(8)
...
_G.sendWebhook = function(received, current)
    ...
    local payload = {
        ...
        ["embeds"] = {{
            ...
            ["footer"] = {
                ["text"] = ".gg/spacerb • " .. localDate .. " • " .. footerTime
            }
        }}
    }
...
updateCollectButton()
_G.print("TDS Farmer Loaded Successfully", "system")
